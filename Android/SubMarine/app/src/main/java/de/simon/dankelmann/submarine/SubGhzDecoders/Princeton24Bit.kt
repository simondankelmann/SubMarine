...
class Princeton24Bit:SubGhzDecoder {
    private var _logTag = "SubGzhDecoder_Princeton24"
    ...
    // SIGNAL PARAMETERS
    private var _validSequenceLength = 24
    private var _intervalDuration = 450 // 450 microseconds
    private var _sequenceBreak = _intervalDuration * 10

    override fun getProtocolName(): String {
        return "Princeton 24 Bit"
    }
    ...
    override fun isValid(signalEntity: SignalEntity): Boolean {
        ...
        if(decodedSequences.isNotEmpty()){
            ...
            _decodedHex = decodedSequences[0].getHexString()
            return true
        }
